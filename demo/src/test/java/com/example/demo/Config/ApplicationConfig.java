...
public class ApplicationConfig {
    ...
    public UserDetailsService userDetailsService(){
        ...
        return username -> (org.springframework.security.core.userdetails.UserDetails) urepo.findByUsername(username).orElseThrow(() -> new UsernameNotFoundException("user not found"));
    }
    @Bean
